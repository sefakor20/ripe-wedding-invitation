    ...
    <div class="fixed inset-0 flex flex-col lg:flex-row">
        ...
        <div class="relative w-full lg:w-1/2 h-1/3 lg:h-full overflow-hidden" x-data="{ 
            ...
            <template x-for="(image, key) in images" :key="key">
                <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out" 
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-emerald-900/70 via-emerald-800/60 to-black/70"></div>
                </div>
            </template>
            ...
            <div class="absolute inset-0 flex items-center justify-center z-20 p-6 lg:p-12">
                <div class="text-center text-white max-w-lg">
                    ...
                    <div class="mb-8">
                        <svg class="w-16 h-16 lg:w-20 lg:h-20 mx-auto text-gold-400/90 drop-shadow-2xl" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="h-px w-32 bg-gradient-to-r from-transparent via-gold-400 to-transparent mx-auto mb-6"></div>
                    ...
                    <!-- Wedding Date Badge -->
                    <div class="inline-block bg-white/10 backdrop-blur-md border border-white/30 rounded-full px-8 py-3 shadow-2xl">
        ...
        <div class="w-full lg:w-1/2 h-2/3 lg:h-full overflow-y-auto bg-white">
            <div class="min-h-full">
                ...
                <section id="hero" class="min-h-screen flex items-center justify-center px-6 lg:px-12 py-20 bg-gradient-to-br from-emerald-50 via-white to-gold-50" 
                         x-data="{ show: true }" 
                         x-init="$dispatch('scroll-section', 'hero')"
                         x-intersect:enter="$dispatch('scroll-section', 'hero')">
                    <div class="max-w-2xl mx-auto text-center" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        ...
                        <div class="flex flex-wrap justify-center gap-6 mb-14">
                            <div class="bg-white border-2 border-emerald-600 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow">
                            ...
                            <div class="bg-white border-2 border-gold-500 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-shadow">
                        ...
                        <div class="bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-3xl p-10 shadow-2xl" x-data="{
                            days: 0,
                            hours: 0,
                            minutes: 0,
                            seconds: 0,
                            ...
                            <div class="text-white text-xs uppercase tracking-widest mb-6 font-semibold opacity-90">Counting Down To Forever</div>
                            <div class="grid grid-cols-4 gap-4 text-center">
                                ...
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-4xl lg:text-5xl font-bold text-gold-300 mb-1" x-text="minutes"></div>
                                    <div class="text-xs uppercase text-white/80">Min</div>
                                </div>
                                <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                                    <div class="text-4xl lg:text-5xl font-bold text-gold-300 mb-1" x-text="seconds"></div>
                ...
                <!-- Schedule Section -->
                <section id="schedule" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'schedule')">
                    <div class="max-w-2xl mx-auto w-full" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex gap-6 group">
                                ...
                                <div class="relative flex-1">
                                    <div class="absolute left-0 top-0 w-4 h-4 rounded-full bg-emerald-600 ring-4 ring-emerald-100"></div>
                                    <div class="ml-8 bg-emerald-50 rounded-xl p-6 group-hover:shadow-lg transition-shadow">
                                        <h3 class="text-xl font-bold text-emerald-800 mb-2">Wedding Ceremony</h3>
                                        <p class="text-gray-600">Join us as we exchange our vows at Madina Rawlings Park</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-6 group">
                                ...
                                <div class="relative flex-1">
                                    <div class="absolute left-0 top-0 w-4 h-4 rounded-full bg-gold-500 ring-4 ring-gold-100"></div>
                                    <div class="ml-8 bg-gold-50 rounded-xl p-6 group-hover:shadow-lg transition-shadow">
                            ...
                            <div class="flex gap-6 group">
                                ...
                                <div class="relative flex-1">
                                    ...
                                    <div class="ml-8 bg-emerald-50 rounded-xl p-6 group-hover:shadow-lg transition-shadow">
                                        ...
                                        <p class="text-gray-600">Celebrate with us with dinner, dancing, and unforgettable memories</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <!-- Dress Code Section -->
                <section id="dress-code" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-gradient-to-b from-emerald-50 to-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'dress')">
                    <div class="max-w-2xl mx-auto w-full" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        ...
                        <div class="bg-white rounded-3xl shadow-2xl p-10">
                            <p class="text-center text-gray-700 text-lg mb-10 leading-relaxed">
                                We kindly request our guests to dress in our wedding colors to create a beautiful, cohesive atmosphere.
                            </p>

                            <div class="grid grid-cols-3 gap-8">
                                <!-- Emerald Green -->
                                <div class="text-center group">
                                    <div class="w-24 h-24 rounded-full bg-emerald-700 mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform ring-4 ring-emerald-100"></div>
                                ...
                                <!-- Gold -->
                                <div class="text-center group">
                                    <div class="w-24 h-24 rounded-full bg-gold-500 mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform ring-4 ring-gold-100"></div>
                                ...
                                <!-- White -->
                                <div class="text-center group">
                                    <div class="w-24 h-24 rounded-full bg-white mx-auto mb-4 shadow-xl group-hover:scale-110 transition-transform ring-4 ring-gray-200 border-2 border-gray-300"></div>
                ...
                <section id="ceremony-note" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'ceremony')">
                    <div class="max-w-2xl mx-auto text-center" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        ...
                        <div class="bg-gradient-to-br from-emerald-50 to-gold-50 rounded-3xl p-10 shadow-xl">
                            <p class="text-gray-700 text-lg leading-relaxed mb-6">
                                Our ceremony will begin promptly at <span class="font-bold text-emerald-700">2:00 PM</span>. 
                                We kindly ask all guests to arrive by <span class="font-bold text-emerald-700">1:45 PM</span> to ensure 
                ...
                <!-- Registry Section -->
                <section id="registry" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-gradient-to-b from-emerald-50 to-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'registry')">
                    <div class="max-w-2xl mx-auto w-full" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        
                        <div class="text-center mb-14">
                            <h2 class="font-cursive text-4xl md:text-5xl text-emerald-700 mb-3">Registry & Gifts</h2>
                            <p class="text-gray-600">Your presence is the greatest gift, but if you wish to honor us...</p>
                        </div>

                        <div class="grid gap-6">
                            <!-- MTN Mobile Money -->
                            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <!-- Telecel Cash -->
                            <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                                <div class="flex items-center justify-between mb-4">
                ...
                <!-- RSVP Section -->
                <section id="rsvp" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'rsvp')">
                    <div class="max-w-2xl mx-auto text-center" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        ...
                        <div class="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-3xl p-10 shadow-2xl text-white">
                            ...
                            <div class="space-y-6">
                                <!-- Call Richard -->
                                <a href="tel:+233244123456" class="block bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-2xl p-6 transition-all group">
                                ...
                                <!-- Call Peace -->
                                <a href="tel:+233201987654" class="block bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-2xl p-6 transition-all group">
                                    <div class="flex items-center justify-center gap-4">
                                        <svg class="w-8 h-8 text-gold-300" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                                        </svg>
                ...
                <!-- Q&A Section -->
                <section id="qa" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-gradient-to-b from-emerald-50 to-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'qa')">
                    <div class="max-w-2xl mx-auto w-full" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                        
                        <div class="text-center mb-14">
                            <h2 class="font-cursive text-4xl md:text-5xl text-emerald-700 mb-3">Questions & Answers</h2>
                ...
                <!-- Location Section -->
                <section id="location" class="min-h-screen flex items-center justify-center py-20 px-6 lg:px-12 bg-white" 
                         x-data="{ show: true }" 
                         x-intersect:enter="$dispatch('scroll-section', 'location')">
                    <div class="max-w-2xl mx-auto w-full" x-show="show" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0">
                ...
                <footer class="bg-emerald-900 text-white py-16 px-6">
                    <div class="max-w-2xl mx-auto text-center">
                        ...
                        <div class="h-px w-32 bg-gradient-to-r from-transparent via-gold-400 to-transparent mx-auto mb-8"></div>
